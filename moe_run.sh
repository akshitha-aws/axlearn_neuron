...
/fsx/akshiaws/axlearn_neuron/setup_node.sh
/fsx/akshiaws/axlearn_neuron/efa_setup.sh
...
export AXLEARN_MAX_SEQUENCE_LENGTH=2048
...
export JOB_ID=switchBase_2_pass
